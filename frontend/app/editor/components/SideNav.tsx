    ...
    return (
        <div className="flex h-full flex-col px-4 py-6 md:px-6 w-full">
            ...
            <div className="flex grow flex-row justify-between md:flex-col md:space-x-0 md:space-y-2 pt-4 border-t border-gray-200 md:pt-8 w-full">
                <a href="/editor/" className="flex h-14 grow items-center justify-center gap-4 p-3 text-[13px] text-[#64748B] font-semibold uppercase tracking-wide hover:bg-gray-100 hover:text-[#10B981] transition-colors md:flex-none md:justify-start md:px-6 cursor-pointer border-l-4 border-[#10B981]">
                    <FaHome className="w-5 h-5" />
                    <p className="hidden md:block">Dashboard</p>
                </a>
                <a href="/editor/publicaciones" className="flex h-14 grow items-center justify-center gap-4 p-3 text-[13px] text-[#64748B] font-semibold uppercase tracking-wide hover:bg-gray-100 hover:text-[#3B82F6] transition-colors md:flex-none md:justify-start md:px-6 cursor-pointer border-l-4 border-[#3B82F6]">
