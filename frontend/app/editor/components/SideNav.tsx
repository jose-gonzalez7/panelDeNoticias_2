    ...
    return (
        ...
        <div className="flex h-full flex-col px-3 py-4 md:px-2">
            ...
            <div className="flex grow flex-row justify-between space-x-2 md:flex-col md:space-x-0 md:space-y-2">
                ...
                <a href="/editor/" className="flex h-12 grow items-center justify-center gap-2 rounded-md 
                ...
                <a href="../editor/publicaciones" className="flex h-12 grow items-center justify-center gap-2 rounded-md 
                bg-slate-500 p-3 text-lg text-white font-bold hover:bg-slate-400 hover:text-white 
                md:flex-none md:justify-start md:p-2 md:px-3">
